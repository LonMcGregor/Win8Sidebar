...
var htmlContent = ' <div id="majorContainer">\
    ...
    <div id="sbContainer">\
        <div id="sb1" class="sideBody" toggle="0">\
            <div class="sideHead sideHead1">Search</div>\
           <div id="sb1Inner"></div>\
        </div>\
        <div id="sb2" class="sideBody" toggle="0">\
            <div class="sideHead sideHead1">Share</div>\
            <div id="sb2Inner"></div>\
        </div>\
        <div id="sb3" class="sideBody" toggle="0">\
            <div class="sideHead sideHead1">Site</div>\
            <div id="sb3Inner"></div>\
        </div>\
        ...
        <div id="sb5" class="sideBody" toggle="0">\
            <div class="sideHead sideHead1">Settings</div>\
            <div id="sb5Inner"></div>\
        </div>\
    </div>';
...
var sb1d = '<div id="searching">\
			...
			<ul>\
				...
				<a href="/tagged/review">\
					<li id="sb1Link2" class="shareItem shareText">Review</li>\
				</a>\
				<a href="/tagged/art">\
					<li id="sb1Link3" class="shareItem shareText">Art</li>\
				</a>\
				<a href="/tagged/reblog">\
					<li id="sb1Link3" class="shareItem shareText">Reblog</li>\
				</a>\
			</ul>';
...
var sb3d = '<ul> {block:Description}<p>{Description}</p>{/block:Description} <p>These are some useful links:</p><a href="http://vbig.tumblr.com/"><li id="sb3Link1" class="shareItem shareText">VBIG</li></a><a href="http://lonsuni.tumblr.com/"><li id="sb3Link2" class="shareItem shareText">LonsUni</li></a><a href="https://twitter.com/lonmcgregor"><li id="sb3Link3" class="shareItem shareText">Twitter</li></a><a href="/about"><li id="sb3Link4" class="shareItem shareText">Address Book</li></a></ul>\
            <div class="sideHead sideHead3">Sidebar information:</div>\
            <ul>\
...
var sb4d = '<ul>\
                ...
                <p>Website Tools:</p>\
                <a href="/submit">\
                    <li id="sb4Link1" class="shareItem shareText">Submit Something</li>\
                </a>\
                <a href="/ask">\
                    <li id="sb4Link2" class="shareItem shareText">Ask Something</li>\
                </a>\
                <a href="http://tumblr.com/follow/lonmcgregor">\
                    <li id="sb4Link3" class="shareItem shareText">Follow</li>\
                </a>\
                <a href="/rss">\
                    <li id="sb4Link4" class="shareItem shareText">RSS Feed</li>\
                </a>\
                <a href="/archive">\
                    <li id="sb4Link5" class="shareItem shareText">Archive</li>\
                </a>\
                <a href="https://www.tumblr.com/liked/by/lonmcgregor">\
                    <li id="sb4Link6" class="shareItem shareText">Liked Posts</li>\
                </a>\
                <a href="/random">\
                    <li id="sb4Link7" class="shareItem shareText">Random</li>\
                </a>\
            </ul>';
var sb5d = '<ul>\
                <p></p>\
...
function sidebarInnerInject(loc, data){
...
function sidebarDims(h) {
	var items = ["METROsidebar", "majorContainer", "sbContainer"];
	for (var i = 0; i < 3; i++) {
...
function moveElementIn(i) {
	document.getElementById('sb' + i).className = document.getElementById('sb' + i).className.replace(/(?:^|\s)out(?!\S)/g, '');
...
function doSearch(event) {
	...
	if (keyCode === 13) {
		window.location = "http://lonmcgregor.tumblr.com/search/" + document.getElementById('searchbox').value;
	}
}
